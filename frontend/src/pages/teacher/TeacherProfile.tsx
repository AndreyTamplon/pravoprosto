...
import { getTeacherProfile, updateTeacherProfile } from '../../api/client';
import type { TeacherProfile as TeacherProfileType } from '../../api/types';
import { Button, ComicPanel, Input, Spinner } from '../../components/ui';
import s from './TeacherProfile.module.css';

export default function TeacherProfile() {
  const { data, loading, error: loadError } = useApi<TeacherProfileType>(getTeacherProfile);
